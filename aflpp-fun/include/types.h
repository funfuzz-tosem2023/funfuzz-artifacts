...
// https://blog.csdn.net/KISSMonX/article/details/9105823
// https://stackoverflow.com/questions/14950614/working-of-asm-volatile-memory
// https://stackoverflow.com/questions/12183311/difference-in-mfence-and-asm-volatile-memory
#define MEM_BARRIER() __asm__ volatile("" ::: "memory")

// `likely` and `unlikely` branch prediction macros: https://stackoverflow.com/questions/109710/how-do-the-likely-unlikely-macros-in-the-linux-kernel-work-and-what-is-their-ben
// They are hint to the compiler to emit instructions that will cause branch
...
// is wrong, then it means the processor pipeline needs to be flushed and can
// cost several cycles. So long as the prediction is correct most of the time,
// this will tend to be good for performance.
#if __GNUC__ < 6
  #ifndef likely
    #define likely(_x) (_x)
  #endif
