...
# Choose compilers
SAN_OPT="-fsanitize=address -fno-omit-frame-pointer"
export __SANITIZE_ADDRESS__=0 # To disable asan at compile time
export CC="clang $SAN_OPT"
export CXX="clang++ $SAN_OPT"
