...
EXT_SCRIPT="$SCRIPT_DIR/seek_extract_data_llvm_cov_region.py"
PLOT_SCRIPT="$SCRIPT_DIR/plot_cov_trend_region.py"
STATS_SCRIPT="$SCRIPT_DIR/stats_final_region.py"
...
echo "python3 $STATS_SCRIPT $DATA_DIR"
python3 "$STATS_SCRIPT" "$DATA_DIR"
