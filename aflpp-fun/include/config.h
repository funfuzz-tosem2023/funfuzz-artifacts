...
// Temp dir under fun mode
#define FUN_TEMP_DIR          "AFL_FUN_TEMP"
#define LOG_SLEEP_S           2U

// Env to make hot cc_shm seen by the PUT
#define FUN_CC_SHM_ENV_VAR    "__FUN_CC_SHM_ID"
#define SHM_IDX               2U
#define CC_IDX_HOT            0U
#define CC_IDX_CLD            1U

// Size of global area for counting calls
#define CC_BYTES              sizeof(u64)
#define FS_BYTES              sizeof(double)
